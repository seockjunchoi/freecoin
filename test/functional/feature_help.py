...
"""Verify that starting fgcoin with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start fgcoin with -h for help text")
        ...
        self.log.info("Start fgcoin with -version for version information")
