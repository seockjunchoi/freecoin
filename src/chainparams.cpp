...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.frcoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.frcointools.com");
        vSeeds.emplace_back("dnsseed.frcoinpool.org");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.frcointools.com");
        vSeeds.emplace_back("seed-b.frcoin.loshan.co.uk");
