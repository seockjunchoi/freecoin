...
const char * const BITCOIN_CONF_FILENAME = "fgcoin.conf";
const char * const BITCOIN_PID_FILENAME = "fgcoind.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Fgcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Fgcoin";
#else
    // Unix
    return pathRet / ".fgcoin";
#endif
#endif
}
