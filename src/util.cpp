...
const char * const BITCOIN_CONF_FILENAME = "freecoin.conf";
const char * const BITCOIN_PID_FILENAME = "freecoind.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/freecoin";
#else
    // Unix
