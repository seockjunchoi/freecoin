...
LITECOIND=${LITECOIND:-$SRCDIR/fgcoind}
LITECOINCLI=${LITECOINCLI:-$SRCDIR/fgcoin-cli}
LITECOINTX=${LITECOINTX:-$SRCDIR/fgcoin-tx}
LITECOINQT=${LITECOINQT:-$SRCDIR/qt/fgcoin-qt}
