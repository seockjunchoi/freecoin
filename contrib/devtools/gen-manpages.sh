...
LITECOIND=${LITECOIND:-$SRCDIR/frcoind}
LITECOINCLI=${LITECOINCLI:-$SRCDIR/frcoin-cli}
LITECOINTX=${LITECOINTX:-$SRCDIR/frcoin-tx}
LITECOINQT=${LITECOINQT:-$SRCDIR/qt/frcoin-qt}
