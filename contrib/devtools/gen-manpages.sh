...
LITECOIND=${LITECOIND:-$SRCDIR/freecoind}
LITECOINCLI=${LITECOINCLI:-$SRCDIR/freecoin-cli}
LITECOINTX=${LITECOINTX:-$SRCDIR/freecoin-tx}
LITECOINQT=${LITECOINQT:-$SRCDIR/qt/freecoin-qt}
